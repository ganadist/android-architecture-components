...
class ProductFragment : LifecycleFragment() {
    ...
    private val mCommentAdapter: CommentAdapter by lazy {
        CommentAdapter(mCommentClickCallback)
    }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        mBinding.productViewModel = ViewModelProviders.of(this, factory)
                .get(ProductViewModel::class.java).apply {
            subscribeToModel(this)
        }
    }
